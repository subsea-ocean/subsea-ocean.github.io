...
<swiper-container navigation="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/about_gallery/about_gallery_2.jpg" class="img-fluid rounded" alt="The SUBSEA team stands on board the ship at night." %}</swiper-slide>
  ...
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/about_gallery/about_gallery_4.jpg" class="img-fluid rounded" alt="Three scientists work together to lift a rack of samples over the edge of the ship." %}</swiper-slide>
</swiper-container>
